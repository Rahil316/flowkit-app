...
| 32  | FlowStory CLI (`flowStory:ls`, `audit:story`)                           | Workspace-Setup | 1     | done    | `scripts/platform/flowStoryDiscovery.js` (discovery) + `scripts/audits/story.js` (validation); format-aware (flat + old nested); `audit:story` wired into `prebuild`. Row otherwise stale (references defunct `scripts/lib/` paths elsewhere in this table) — needs a full pass, out of scope here                                                                                                                                                                                                                                             |
...
| 39  | CLI contract smoke tests (flowStory:ls/audit:story/status/lens/migrate) | Workspace-Setup | 1     | done    | Row stale — referenced `scripts/tests/plan-contract-cli.test.js` no longer exists; needs a full pass, out of scope here                                                                                                                                                                                                                                                                                                                                                                                                                                    |
