...
import { gameDemoScaffold } from '../demoBooks/game-demo-scaffold.js'
...
describe('Suite N — scaffold.js demo-content parity with the shared game-demo module', () => {
  it('N1 — scaffold.js emits the same demo flow ids as gameDemoScaffold()', () => {
    ...
    const sharedChapterIds = new Set(
    ...
    assert.deepEqual(
      [...chapterIds].sort(),
      [...sharedChapterIds].sort(),
      'scaffold.js demo chapter ids diverged from gameDemoScaffold() — scaffold.js may no longer be calling it'
    )
  })
